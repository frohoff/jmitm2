...
public class FileAttributes {
  ...
  public void setPermissions(String permissions) {
    ...
    if(len >= 1)
      cp = (permissions.charAt(0)=='r') ? FileAttributes.S_IRUSR : 0;
    if(len >= 2)
      cp = cp | ((permissions.charAt(1)=='w') ? FileAttributes.S_IWUSR : 0);
    if(len >= 3)
      cp = cp | ((permissions.charAt(2)=='x') ? FileAttributes.S_IXUSR : 0);
    if(len >= 4)
      cp = cp | ((permissions.charAt(3) == 'r') ? FileAttributes.S_IRGRP : 0);
    if(len >= 5)
      cp = cp | ((permissions.charAt(4) == 'w') ? FileAttributes.S_IWGRP : 0);
    if(len >= 6)
      cp = cp | ((permissions.charAt(5)=='x') ? FileAttributes.S_IXGRP : 0);
    if(len >= 7)
      cp = cp | ((permissions.charAt(6) == 'r') ? FileAttributes.S_IROTH : 0);
    if(len >= 8)
      cp = cp | ((permissions.charAt(7) == 'w') ? FileAttributes.S_IWOTH : 0);
    if(len >= 9)
      cp = cp | ((permissions.charAt(8)=='x') ? FileAttributes.S_IXOTH : 0);
