 ...
 * @version $Id: TransportProtocolServer.java,v 1.31 2003/02/22 13:35:53 martianx Exp $
 */
public class TransportProtocolServer
        ...
        if (privateKeyFile!=null) {
           ...
           in = new FileInputStream(privateKeyFile);
            ...
            if(!pkf.isPassphraseProtected()) {
              ...
              log.warn(privateKeyFile
                + " cannot be used as it is passphrase protected");
    ...
    private void onMsgServiceRequest(SshMsgServiceRequest msg)
      ...
      if (acceptServices.containsKey(msg.getServiceName())) {
            ...
            service.init(Service.ACCEPTING_SERVICE, this, null);
            service.start();
        } else {
