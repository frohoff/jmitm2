 ...
 *@version    $Id: DhGroup1Sha1.java,v 1.11 2003/02/06 18:33:58 martianx Exp $
 */
public class DhGroup1Sha1
    ...
    public void performClientExchange(String clientId, String serverId,
        ...
        SshMsgKexDhReply reply =
                (SshMsgKexDhReply) transport.readMessage(messageId);
    ...
    public void performServerExchange(String clientId, String serverId,
        ...
        try {
            ...
            SshMsgKexDhInit msg =
                    (SshMsgKexDhInit) transport.readMessage(messageId);
