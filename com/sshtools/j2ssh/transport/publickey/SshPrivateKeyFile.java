...
public class SshPrivateKeyFile {
    ...
    public static SshPrivateKeyFile parse(byte formattedKey[])
        ...
        format = SshPrivateKeyFormatFactory.newInstance(
                     SshPrivateKeyFormatFactory.getDefaultFormatType());
        ...
        if(valid)
          return new SshPrivateKeyFile(format.getKeyBlob(formattedKey),
                                       format);
        else
